...
const StudentCV = () => {
    return (
        <div>
            ...
            <section class="page-content course-sec" style={{ textAlign: 'left' }}>
                <div class="container">
                    <div class="row">
                        <div class="col-lg-8">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="contact-info-list">
                                        <div class="edu-wrap">
                                            ...
                                            <div class="edu-detail">
                                                <h6>Email</h6>
                                                <p><a href="javascript:;"><span class="__cf_email__" data-cfemail="3c56595252454b55504f53527c59445d514c5059125f5351">[email&#160;protected]</span></a></p>
                                            </div>
                                        </div>
                                        <div class="edu-wrap">
                                            <div class="edu-name">
